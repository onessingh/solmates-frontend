...
# I will replace the previous block with the new one
custom_css = '''
...
@media (prefers-color-scheme: dark) {
    ...
    .question-text, .loading-title, .review-item .q-num, .timer {
        color: #f8fafc !important;
    }
    .loading-sub, .review-item .explanation, .progress-label {
        color: #94a3b8 !important;
    }
...
with open(html_path, 'w', encoding='utf-8') as f:
    f.write(html)
print("Added timer to dark mode fixes")
