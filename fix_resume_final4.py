...
@media (prefers-color-scheme: dark) {
    ...
    /* Interface Cards */
    .card, .form-panel, .panel-section, .hero, .rb-tab-content, .white-box, .metric, .template-card, .rb-tabs, .wizard-header, .builder-layout, .jd-match, .score-card, .jd-score-card, .repeater-item, .section-item, .wizard-nav, .jd-panel, .chip-wrapper { 
...
html = re.sub(r'style\.css\?v=[0-9.]+', 'style.css?v=113.1', html)
