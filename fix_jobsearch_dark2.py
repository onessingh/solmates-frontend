...
@media (prefers-color-scheme: dark) {
    ...
    .container, .sol-form-wrap, .sol-card, .tab-btn.active, .results-controls, .skeleton-card {
    ...
    /* Headers & Text */
    h1, h2, h3, h4, h5, h6, .sol-form-title, .tab-btn.active, .sol-title, .sol-company { color: #f8fafc !important; }
    p, span, label, .sol-form-label, .tab-btn, .sol-meta-item, .sol-desc, .platforms-info { color: #94a3b8 !important; }
...
with open(html_path, 'w', encoding='utf-8') as f:
    f.write(html)
print("Injected custom dark mode for job search with Skeletons")
