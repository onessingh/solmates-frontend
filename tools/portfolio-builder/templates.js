const templates = {
  ...
  premium_3d_auto_waves_glass: {
    name: "?? Ocean Waves + Frosted Glass",
    isAdvanced: true,
    css: `
      ...
      .hero { background: rgba(20,20,30,0.5); backdrop-filter: blur(15px); border: 1px solid rgba(255,255,255,0.1); border-radius: 20px; padding: 50px; margin-bottom: 50px; transform-style: preserve-3d; }
      h1 { font-size: 4rem; margin: 0 0 10px; color: #fff; transform: translateZ(40px); }
      .title { font-size: 1.5rem; color: var(--p); transform: translateZ(30px); margin-bottom: 20px; }
      .about-text { font-size: 1.1rem; line-height: 1.8; color: #ddd; transform: translateZ(20px); }
      .btn { display: inline-block; padding: 12px 25px; margin: 20px 10px 0 0; border: 1px solid var(--p); color: #fff; text-decoration: none; font-weight: bold; background: rgba(0,0,0,0.5); transition: 0.3s; transform: translateZ(25px); }
      .btn:hover { background: var(--p); color: #000; }
      h2 { font-size: 2.2rem; border-bottom: 2px solid var(--p); display: inline-block; padding-bottom: 10px; margin-top: 40px; }
      .grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; margin-top: 30px; }
      .card { background: rgba(20,20,30,0.5); backdrop-filter: blur(15px); border: 1px solid rgba(255,255,255,0.1); border-radius: 20px; padding: 30px; transform-style: preserve-3d; transition: 0.3s; }
      .card h3 { color: #fff; transform: translateZ(30px); margin: 0 0 10px; }
      .card .meta { color: var(--p); font-weight: 600; transform: translateZ(25px); margin-bottom: 10px; }
      .card p { color: #ccc; transform: translateZ(20px); }
      .skill-tag { display: inline-block; padding: 10px 20px; margin: 5px; background: rgba(20,20,30,0.5); backdrop-filter: blur(15px); border: 1px solid rgba(255,255,255,0.1); border-radius: 20px; }
...
<body>
  <div id="bg"></div>
  <div class="container">
    <div class="hero" data-tilt data-tilt-max="3" data-tilt-perspective="1000">
      {PHOTO}
      <h1>{NAME}</h1>
    ...
    <h2>Arsenal</h2>
    <div style="margin-top:20px;">{SKILLS}</div>
  ...
  <script>
    ...
    VANTA.WAVES({ el: "#bg", color: accentColor, waveHeight: 20, waveSpeed: 1, zoom: 1 });
    VanillaTilt.init(document.querySelectorAll(".card, .hero"), { max: 10, speed: 400, glare: true, "max-glare": 0.2 });
  </script>
</body>
</html>`,
    ...
    projLayout: `<div class="card"><h3>{TITLE}</h3><p>{DESC}</p><a href="{LINK}" class="btn">View Source</a></div>`,
    photoLayout: `<img src="{PHOTO_SRC}" style="width:150px; height:150px; border-radius:50%; object-fit:cover; border:3px solid var(--p); transform:translateZ(40px); box-shadow:0 0 20px rgba(0,0,0,0.5); margin-bottom: 20px;">`
  },

  premium_3d_auto_waves_holo: {
    name: "?? Ocean Waves + Hologram",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
      ...
      #bg { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: -1; }
      .container { max-width: 1100px; margin: 0 auto; padding: 60px 20px; }
      .hero { background: linear-gradient(135deg, rgba(255,255,255,0.1), rgba(255,255,255,0)); border: 1px solid var(--p); border-radius: 10px; box-shadow: inset 0 0 20px rgba(255,255,255,0.1); padding: 50px; margin-bottom: 50px; transform-style: preserve-3d; }
      h1 { font-size: 4rem; margin: 0 0 10px; color: #fff; transform: translateZ(40px); }
      .title { font-size: 1.5rem; color: var(--p); transform: translateZ(30px); margin-bottom: 20px; }
      .about-text { font-size: 1.1rem; line-height: 1.8; color: #ddd; transform: translateZ(20px); }
      .btn { display: inline-block; padding: 12px 25px; margin: 20px 10px 0 0; border: 1px solid var(--p); color: #fff; text-decoration: none; font-weight: bold; background: rgba(0,0,0,0.5); transition: 0.3s; transform: translateZ(25px); }
      ...
      h2 { font-size: 2.2rem; border-bottom: 2px solid var(--p); display: inline-block; padding-bottom: 10px; margin-top: 40px; }
      .grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; margin-top: 30px; }
      .card { background: linear-gradient(135deg, rgba(255,255,255,0.1), rgba(255,255,255,0)); border: 1px solid var(--p); border-radius: 10px; box-shadow: inset 0 0 20px rgba(255,255,255,0.1); padding: 30px; transform-style: preserve-3d; transition: 0.3s; }
      .card h3 { color: #fff; transform: translateZ(30px); margin: 0 0 10px; }
      .card .meta { color: var(--p); font-weight: 600; transform: translateZ(25px); margin-bottom: 10px; }
      .card p { color: #ccc; transform: translateZ(20px); }
      .skill-tag { display: inline-block; padding: 10px 20px; margin: 5px; background: linear-gradient(135deg, rgba(255,255,255,0.1), rgba(255,255,255,0)); border: 1px solid var(--p); border-radius: 10px; box-shadow: inset 0 0 20px rgba(255,255,255,0.1); }
      @media(max-width: 768px) { h1 { font-size: 2.5rem; } }
    `,
    htmlLayout: `<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  premium_3d_auto_waves_cyber: {
    name: "?? Ocean Waves + Cyberpunk",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
      ...
      #bg { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: -1; }
      .container { max-width: 1100px; margin: 0 auto; padding: 60px 20px; }
      .hero { background: rgba(0,0,0,0.8); border: 2px solid var(--p); clip-path: polygon(5% 0, 100% 0, 95% 100%, 0 100%); padding: 50px; margin-bottom: 50px; transform-style: preserve-3d; }
      h1 { font-size: 4rem; margin: 0 0 10px; color: #fff; transform: translateZ(40px); }
      .title { font-size: 1.5rem; color: var(--p); transform: translateZ(30px); margin-bottom: 20px; }
      .about-text { font-size: 1.1rem; line-height: 1.8; color: #ddd; transform: translateZ(20px); }
      .btn { display: inline-block; padding: 12px 25px; margin: 20px 10px 0 0; border: 1px solid var(--p); color: #fff; text-decoration: none; font-weight: bold; background: rgba(0,0,0,0.5); transition: 0.3s; transform: translateZ(25px); }
      ...
      h2 { font-size: 2.2rem; border-bottom: 2px solid var(--p); display: inline-block; padding-bottom: 10px; margin-top: 40px; }
      .grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; margin-top: 30px; }
      .card { background: rgba(0,0,0,0.8); border: 2px solid var(--p); clip-path: polygon(5% 0, 100% 0, 95% 100%, 0 100%); padding: 30px; transform-style: preserve-3d; transition: 0.3s; }
      .card h3 { color: #fff; transform: translateZ(30px); margin: 0 0 10px; }
      .card .meta { color: var(--p); font-weight: 600; transform: translateZ(25px); margin-bottom: 10px; }
      .card p { color: #ccc; transform: translateZ(20px); }
      .skill-tag { display: inline-block; padding: 10px 20px; margin: 5px; background: rgba(0,0,0,0.8); border: 2px solid var(--p); clip-path: polygon(5% 0, 100% 0, 95% 100%, 0 100%); }
      @media(max-width: 768px) { h1 { font-size: 2.5rem; } }
    `,
    htmlLayout: `<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  premium_3d_auto_waves_brutal: {
    name: "?? Ocean Waves + Brutalism",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
      ...
      #bg { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: -1; }
      .container { max-width: 1100px; margin: 0 auto; padding: 60px 20px; }
      .hero { background: #000; border: 4px solid #fff; box-shadow: 10px 10px 0 var(--p); border-radius: 0; padding: 50px; margin-bottom: 50px; transform-style: preserve-3d; }
      h1 { font-size: 4rem; margin: 0 0 10px; color: #fff; transform: translateZ(40px); }
      .title { font-size: 1.5rem; color: var(--p); transform: translateZ(30px); margin-bottom: 20px; }
      .about-text { font-size: 1.1rem; line-height: 1.8; color: #ddd; transform: translateZ(20px); }
      .btn { display: inline-block; padding: 12px 25px; margin: 20px 10px 0 0; border: 1px solid var(--p); color: #fff; text-decoration: none; font-weight: bold; background: rgba(0,0,0,0.5); transition: 0.3s; transform: translateZ(25px); }
      ...
      h2 { font-size: 2.2rem; border-bottom: 2px solid var(--p); display: inline-block; padding-bottom: 10px; margin-top: 40px; }
      .grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; margin-top: 30px; }
      .card { background: #000; border: 4px solid #fff; box-shadow: 10px 10px 0 var(--p); border-radius: 0; padding: 30px; transform-style: preserve-3d; transition: 0.3s; }
      .card h3 { color: #fff; transform: translateZ(30px); margin: 0 0 10px; }
      .card .meta { color: var(--p); font-weight: 600; transform: translateZ(25px); margin-bottom: 10px; }
      .card p { color: #ccc; transform: translateZ(20px); }
      .skill-tag { display: inline-block; padding: 10px 20px; margin: 5px; background: #000; border: 4px solid #fff; box-shadow: 10px 10px 0 var(--p); border-radius: 0; }
      @media(max-width: 768px) { h1 { font-size: 2.5rem; } }
    `,
    htmlLayout: `<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  premium_3d_auto_waves_minimal: {
    name: "?? Ocean Waves + Minimal 3D",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
      ...
      #bg { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: -1; }
      .container { max-width: 1100px; margin: 0 auto; padding: 60px 20px; }
      .hero { background: rgba(255,255,255,0.05); border-left: 5px solid var(--p); border-radius: 5px; padding: 50px; margin-bottom: 50px; transform-style: preserve-3d; }
      h1 { font-size: 4rem; margin: 0 0 10px; color: #fff; transform: translateZ(40px); }
      .title { font-size: 1.5rem; color: var(--p); transform: translateZ(30px); margin-bottom: 20px; }
      .about-text { font-size: 1.1rem; line-height: 1.8; color: #ddd; transform: translateZ(20px); }
      .btn { display: inline-block; padding: 12px 25px; margin: 20px 10px 0 0; border: 1px solid var(--p); color: #fff; text-decoration: none; font-weight: bold; background: rgba(0,0,0,0.5); transition: 0.3s; transform: translateZ(25px); }
      ...
      h2 { font-size: 2.2rem; border-bottom: 2px solid var(--p); display: inline-block; padding-bottom: 10px; margin-top: 40px; }
      .grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; margin-top: 30px; }
      .card { background: rgba(255,255,255,0.05); border-left: 5px solid var(--p); border-radius: 5px; padding: 30px; transform-style: preserve-3d; transition: 0.3s; }
      .card h3 { color: #fff; transform: translateZ(30px); margin: 0 0 10px; }
      .card .meta { color: var(--p); font-weight: 600; transform: translateZ(25px); margin-bottom: 10px; }
      .card p { color: #ccc; transform: translateZ(20px); }
      .skill-tag { display: inline-block; padding: 10px 20px; margin: 5px; background: rgba(255,255,255,0.05); border-left: 5px solid var(--p); border-radius: 5px; }
      @media(max-width: 768px) { h1 { font-size: 2.5rem; } }
    `,
    htmlLayout: `<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  premium_3d_auto_birds_glass: {
    name: "?? Flock of Birds + Frosted Glass",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  <script>
    let accentColor = parseInt("{COLOR}".replace('#', '0x')) || 0x00ffcc;
    VANTA.BIRDS({ el: "#bg", backgroundColor: 0x0, color1: accentColor, color2: 0xffffff, birdSize: 2, wingSpan: 30, separation: 50 });
    VanillaTilt.init(document.querySelectorAll(".card, .hero"), { max: 10, speed: 400, glare: true, "max-glare": 0.2 });
  </script>
</body>
</html>`,
  ...
  premium_3d_auto_birds_holo: {
    name: "?? Flock of Birds + Hologram",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_birds_cyber: {
    name: "?? Flock of Birds + Cyberpunk",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_birds_brutal: {
    name: "?? Flock of Birds + Brutalism",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_birds_minimal: {
    name: "?? Flock of Birds + Minimal 3D",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_halo_glass: {
    name: "?? Neon Halo + Frosted Glass",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  <script>
    let accentColor = parseInt("{COLOR}".replace('#', '0x')) || 0x00ffcc;
    VANTA.HALO({ el: "#bg", backgroundColor: 0x0, baseColor: accentColor, amplitudeFactor: 2, size: 2 });
    VanillaTilt.init(document.querySelectorAll(".card, .hero"), { max: 10, speed: 400, glare: true, "max-glare": 0.2 });
  </script>
</body>
</html>`,
  ...
  premium_3d_auto_halo_holo: {
    name: "?? Neon Halo + Hologram",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_halo_cyber: {
    name: "?? Neon Halo + Cyberpunk",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_halo_brutal: {
    name: "?? Neon Halo + Brutalism",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_halo_minimal: {
    name: "?? Neon Halo + Minimal 3D",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_rings_glass: {
    name: "?? 3D Rings + Frosted Glass",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  <script>
    let accentColor = parseInt("{COLOR}".replace('#', '0x')) || 0x00ffcc;
    VANTA.RINGS({ el: "#bg", backgroundColor: 0x0, color: accentColor });
    VanillaTilt.init(document.querySelectorAll(".card, .hero"), { max: 10, speed: 400, glare: true, "max-glare": 0.2 });
  </script>
</body>
</html>`,
  ...
  premium_3d_auto_rings_holo: {
    name: "?? 3D Rings + Hologram",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_rings_cyber: {
    name: "?? 3D Rings + Cyberpunk",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_rings_brutal: {
    name: "?? 3D Rings + Brutalism",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_rings_minimal: {
    name: "?? 3D Rings + Minimal 3D",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_topology_glass: {
    name: "?? Topology Map + Frosted Glass",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  <script>
    let accentColor = parseInt("{COLOR}".replace('#', '0x')) || 0x00ffcc;
    VANTA.TOPOLOGY({ el: "#bg", backgroundColor: 0x0, color: accentColor });
    VanillaTilt.init(document.querySelectorAll(".card, .hero"), { max: 10, speed: 400, glare: true, "max-glare": 0.2 });
  </script>
</body>
</html>`,
  ...
  premium_3d_auto_topology_holo: {
    name: "?? Topology Map + Hologram",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_topology_cyber: {
    name: "?? Topology Map + Cyberpunk",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_topology_brutal: {
    name: "?? Topology Map + Brutalism",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_topology_minimal: {
    name: "?? Topology Map + Minimal 3D",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_cells_glass: {
    name: "?? Cellular 3D + Frosted Glass",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  <script>
    let accentColor = parseInt("{COLOR}".replace('#', '0x')) || 0x00ffcc;
    VANTA.CELLS({ el: "#bg", backgroundColor: 0x0, color1: accentColor, color2: 0xffffff });
    VanillaTilt.init(document.querySelectorAll(".card, .hero"), { max: 10, speed: 400, glare: true, "max-glare": 0.2 });
  </script>
</body>
</html>`,
  ...
  premium_3d_auto_cells_holo: {
    name: "?? Cellular 3D + Hologram",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_cells_cyber: {
    name: "?? Cellular 3D + Cyberpunk",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_cells_brutal: {
    name: "?? Cellular 3D + Brutalism",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_cells_minimal: {
    name: "?? Cellular 3D + Minimal 3D",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_dots_glass: {
    name: "?? Floating Dots + Frosted Glass",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  <script>
    let accentColor = parseInt("{COLOR}".replace('#', '0x')) || 0x00ffcc;
    VANTA.DOTS({ el: "#bg", backgroundColor: 0x0, color: accentColor, color2: 0xffffff, size: 4, spacing: 30 });
    VanillaTilt.init(document.querySelectorAll(".card, .hero"), { max: 10, speed: 400, glare: true, "max-glare": 0.2 });
  </script>
</body>
</html>`,
  ...
  premium_3d_auto_dots_holo: {
    name: "?? Floating Dots + Hologram",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_dots_cyber: {
    name: "?? Floating Dots + Cyberpunk",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_dots_brutal: {
    name: "?? Floating Dots + Brutalism",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_dots_minimal: {
    name: "?? Floating Dots + Minimal 3D",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_fog_glass: {
    name: "?? Thick Fog + Frosted Glass",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  <script>
    let accentColor = parseInt("{COLOR}".replace('#', '0x')) || 0x00ffcc;
    VANTA.FOG({ el: "#bg", highlightColor: accentColor, midtoneColor: 0xffffff, lowlightColor: 0x0, baseColor: 0x0 });
    VanillaTilt.init(document.querySelectorAll(".card, .hero"), { max: 10, speed: 400, glare: true, "max-glare": 0.2 });
  </script>
</body>
</html>`,
  ...
  premium_3d_auto_fog_holo: {
    name: "?? Thick Fog + Hologram",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_fog_cyber: {
    name: "?? Thick Fog + Cyberpunk",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_fog_brutal: {
    name: "?? Thick Fog + Brutalism",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
...
<body>
  ...
  premium_3d_auto_fog_minimal: {
    name: "?? Thick Fog + Minimal 3D",
    isAdvanced: true,
    css: `
      @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap');
      :root { --p: {COLOR}; }
