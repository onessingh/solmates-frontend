(() => {
  ...
  const renderResume = (resume, templateKey) => {
        ...
        return `
          <article class="resume template-cybersec" style="display:block!important;width:100%!important;min-height:100%!important;font-family:'Consolas', 'Courier New', monospace;color:#c9d1d9;background:#0d1117;padding:50px;box-sizing:border-box;">
            ...
            <header style="border-bottom: 2px solid #00ff41; padding-bottom: 30px; margin-bottom: 30px; display: flex; justify-content: space-between; align-items: flex-end;">
              <div>
                <div style="color:#00ff41;font-size:0.9rem;margin-bottom:5px;">guest@solmates:~$ whoami</div>
    ...
    if (templateKey === "forestSidebar") {
      ...
      return `
        <article class="resume template-forestSidebar" style="display:block!important;width:100%!important;min-height:100%!important;font-family:'Inter',sans-serif;color:#333;background:#fff;box-shadow:0 10px 30px rgba(0,0,0,0.1);overflow:hidden;">
...
<html lang="en">
  <head>
    ...
    <style>
      ...
      ${['modernSidebar','monochromeSplit','centerArch'].includes(state.selectedTemplate)
