(() => {
  ...
  const renderResume = (resume, templateKey) => {
    ...
    if (templateKey === "forestSidebar") {
      ...
      return `
        <article class="resume template-forestSidebar" style="display:flex!important;flex-direction:row!important;width:800px!important;max-width:800px!important;min-height:1122px!important;margin:0 auto;font-family:'Inter',sans-serif;color:#333;background:#fff;align-items:stretch!important;box-shadow:0 10px 30px rgba(0,0,0,0.1);overflow:hidden;">
          <aside class="resume-sidebar" style="width:34%!important;flex-shrink:0!important;background:linear-gradient(180deg,#1b2823,#0d1411);color:#e5e0d8;display:flex!important;flex-direction:column!important;">
            ...
            <div style="padding:25px 22px;flex:1;">
    ...
    if (templateKey === "monochromeSplit") {
      ...
      const mainSections = generateSections(mainKeys);
      return `
        <article class="resume template-monochromeSplit" style="display:flex!important;flex-direction:row!important;width:800px!important;max-width:800px!important;min-height:1122px!important;margin:0 auto;font-family:'Inter',sans-serif;background:#fff;box-shadow:0 10px 30px rgba(0,0,0,0.1);overflow:hidden;">
          <aside class="resume-sidebar" style="width:38%!important;flex-shrink:0!important;display:flex!important;flex-direction:column!important;">
            <div style="background:#fff;padding:40px 30px 25px;">
              <h1 style="color:#111;font-size:2.8rem;font-weight:900;text-transform:uppercase;word-break:break-word;line-height:1.1;margin-bottom:10px;">${escapeHtml(personal.fullName || "Name").replace(/ /g, '<br>')}</h1>
            </div>
            ...
            <div style="background:#111;color:#eee;flex:1!important;padding:30px;">
          ...
          <main class="resume-main" style="flex:1!important;background:#f5f5f5;padding:45px 40px;box-sizing:border-box;">
    ...
    if (templateKey === "centerArch") {
      ...
      return `
        <article class="resume template-centerArch" style="display:flex!important;flex-direction:row!important;width:800px!important;max-width:800px!important;min-height:1122px!important;margin:0 auto;font-family:'Outfit',sans-serif;color:#555;background:#fff;align-items:stretch!important;position:relative;border-top:20px solid #d1c7bc;border-bottom:20px solid #888;box-shadow:0 10px 30px rgba(0,0,0,0.1);overflow:hidden;">
          <div class="left-col" style="flex:0 0 32%!important;width:32%!important;padding:40px 25px 30px;box-sizing:border-box;text-align:right;">
          ...
          <div class="center-col" style="flex:0 0 36%!important;width:36%!important;background:#f1ede9;text-align:center;border-radius:200px 200px 0 0;margin-top:20px;padding:30px 20px 30px;box-sizing:border-box;">
            <img src="${personal.photoDataUrl || '/tools/resumebuilder/default-avatar.png'}" alt="Profile" style="width:140px;height:140px;object-fit:cover;border-radius:50%;display:block;margin:0 auto 20px;" />
            <h1 style="font-size:2.2rem;color:#c1a58d;text-transform:uppercase;letter-spacing:3px;margin-bottom:6px;line-height:1.2;">${escapeHtml(personal.fullName || "Name").replace(/ /g, '<br>')}</h1>
          ...
          <div class="right-col" style="flex:0 0 32%!important;width:32%!important;padding:40px 25px 30px;box-sizing:border-box;text-align:left;">
    ...
    if (templateKey === "navyOverlap") {
      ...
      return `
        <article class="resume template-navyOverlap" style="display:block!important;width:800px!important;max-width:800px!important;min-height:1122px!important;margin:0 auto;font-family:'Inter',sans-serif;background:#f4f6f8;box-shadow:0 10px 30px rgba(0,0,0,0.1);padding-top:50px;overflow:hidden;">
          <header style="padding:0 50px 25px;">
          ...
          <div style="display:flex!important;flex-direction:row!important;position:relative;">
            <main style="flex:1!important;padding:30px 50px 40px;box-sizing:border-box;">
            ...
            <aside style="flex:0 0 35%!important;width:35%!important;background:#2a3b4c;color:#e0e6ed;padding:100px 30px 40px;box-sizing:border-box;position:relative;">
    ...
    if (templateKey === "floralSidebar") {
      ...
      const mainSections = generateSections(mainKeys);
      return `
        <article class="resume template-floralSidebar" style="display:flex!important;flex-direction:row!important;width:800px!important;max-width:800px!important;min-height:1122px!important;margin:0 auto;font-family:'Georgia',serif;color:#444;background:#fff;box-shadow:0 10px 30px rgba(0,0,0,0.1);overflow:hidden;">
          <aside class="resume-sidebar" style="width:34%!important;flex-shrink:0!important;background:#e8e8e8;padding:45px 30px;box-sizing:border-box;text-align:center;">
          ...
          <main class="resume-main" style="flex:1!important;padding:55px 45px;background:#fff;box-sizing:border-box;">
