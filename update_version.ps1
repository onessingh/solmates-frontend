...
foreach ($f in $files) {
    if (Test-Path $f) {
        ...
        $content = $content -replace 'global-lockdown\.css\?v=111\.9', 'global-lockdown.css?v=112.0'
        $content = $content -replace 'global-lockdown\.css', 'global-lockdown.css?v=112.0'
        $content = $content -replace 'global-lockdown\.css\?v=112\.0\?v=112\.0', 'global-lockdown.css?v=112.0'
