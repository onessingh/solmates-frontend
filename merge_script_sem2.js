const fs = require('fs');
const newQuestions = require('./sem2_expansion.js');
...
// Add the new questions to Sem 2
...
console.log('Sem 2 expansion applied. Total questions in Corp Fin:', quizData.questionBank["Corporate Finance"].length);
