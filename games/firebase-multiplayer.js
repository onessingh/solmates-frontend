        ...
        db.ref('solmates-rooms/' + hostId).once('value', snap => {
            ...
            const evalHostDisconnect = (disconnectTime) => {
                ...
                if (elapsed > 12000) {
                    ...
                    disconnectTimers.push(setTimeout(() => evalHostDisconnect(disconnectTime), Math.max(12000 - elapsed, 2000)));
                } else {
                    disconnectTimers.push(setTimeout(() => evalHostDisconnect(disconnectTime), Math.max(4000 - elapsed, 1000)));
                }
            };
