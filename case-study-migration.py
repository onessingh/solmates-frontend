...
with open('games/case-study-arena/game.js', 'r', encoding='utf-8') as f:
    js = f.read()
...
# Case Study merges settings too.

with open('games/case-study-arena/game.js', 'w', encoding='utf-8') as f:
    f.write(js)
