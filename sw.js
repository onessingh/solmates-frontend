/*
 * SOLMATES Service Worker (v115.6 - NUCLEAR REFRESH)
...
self.addEventListener('push', function(event) {
    ...
    try {
        ...
        const options = {
            ...
            // v115.6: High-urgency vibration pattern for class reminders
            vibrate: [300, 100, 300, 100, 300, 100, 400],
            // v115.6: Stack by Default, but with renotify buzzer
            tag: 'solmates-alert-' + (data.type || 'msg'),
            renotify: true,
            requireInteraction: true,
            timestamp: Date.now(),
            // v115.6: Priority hint
            priority: 'high', 
            data: {
...
const CACHE_NAME = 'solmates-cache-v86';
const STATIC_ASSETS = [
    '/',
    '/index.html',
    '/manifest.json',
