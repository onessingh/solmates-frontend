/*
 * SOLMATES Service Worker (v117.3 - START Recovery System)
...
self.addEventListener('push', function(event) {
    ...
    try {
        ...
        const options = {
            ...
            // v115.9: High-urgency vibration pattern for class reminders
            vibrate: [300, 100, 300, 100, 300, 100, 400],
            // v115.9: Stack by Default, but with renotify buzzer
            tag: 'solmates-alert-' + (data.type || 'msg'),
            renotify: true,
            requireInteraction: true,
            timestamp: Date.now(),
            // v115.9: Priority hint
            priority: 'high', 
            data: {
...
const CACHE_NAME = 'solmates-cache-v365';
const STATIC_ASSETS = [
    '/',
    '/index.html',
    '/manifest.json',
