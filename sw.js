/*
 * SOLMATES Service Worker (v115.5 - NUCLEAR REFRESH)
...
self.addEventListener('push', function(event) {
    ...
    try {
        ...
        const options = {
            ...
            // v115.5: High-urgency vibration pattern for class reminders
            vibrate: [300, 100, 300, 100, 300, 100, 400],
            // v115.5: Stack by Default, but with renotify buzzer
            tag: 'solmates-alert-' + (data.type || 'msg'),
            renotify: true,
            requireInteraction: true,
            timestamp: Date.now(),
            // v115.5: Priority hint
            priority: 'high', 
            data: {
...
const CACHE_NAME = 'solmates-cache-v85';
const STATIC_ASSETS = [
    '/',
    '/index.html',
    '/manifest.json',
