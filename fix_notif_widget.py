...
BOT = '8597525439:AAEV6WWYB3KXReoaNmbUoNWQqCyPvUe2laY'
CHAT = '1772865405'
...
WIDGET = (
    ...
    'html[data-solmates-theme=dark] #queryModal{--qbg:#1e293b;--qtxt:#e2e8f0;--qhead:#c0962d;--qsub:#94a3b8;--qlabel:#cbd5e1;--qborder:#334155;--qinput:#0f172a}\n'
    '</style>\n'
    ...
    '  var BAD=["fuck","shit","chutiya","madarchod","bhenchod","bsdk","randi","gandu","lund","lauda","chod","sex","porn","xxx"];\n'
    '  function qBad(t){if(!t)return false;var l=t.toLowerCase();return BAD.some(function(w){return l.includes(w);});}\n'
    ...
    '    if(qBad(n)||qBad(qq)){alert("Please keep your query respectful.");return;}\n'
    ...
    '    try{\n'
    '      var r=await fetch("https://api.telegram.org/bot' + BOT + '/sendMessage",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:"' + CHAT + '",text:msg})});\n'
...
if '</body>' in content:
    ...
    with open(path, 'w', encoding='utf-8', errors='replace') as f:
        f.write(content)
    print('DONE: notification.html')
else:
    print('ERROR: No closing body tag')
